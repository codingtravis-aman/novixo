  ...
  const techCategories = [
    {
      ...
      technologies: [
        ...
        { name: 'Remix', icon: <SiRemix className="w-8 h-8" /> },
        { name: 'Qwik', icon: <SiQwik className="w-8 h-8" /> },
        ...
        { name: 'ShadCN UI', icon: <SiShadcnui className="w-8 h-8" /> },
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: 'Bun.js', icon: <SiBun className="w-8 h-8" /> },
      ],
    },
    {
      name: 'Mobile',
      technologies: [
        ...
        { name: 'Expo', icon: <SiExpo className="w-8 h-8" /> },
      ],
    },
    {
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: 'Turborepo', icon: <SiTurborepo className="w-8 h-8" /> },
    ...
    },
    {
      name: 'AI & LLM Tools',
      technologies: [
        { name: 'LangChain', icon: <SiChainlink className="w-8 h-8" /> },
        { name: 'LlamaIndex', icon: <SiGnubash className="w-8 h-8" /> },
        { name: 'Pinecone', icon: <SiSimpleicons className="w-8 h-8" /> },
      ],
    },
    {
      name: 'Analytics & Monitoring',
      technologies: [
        { name: 'Plausible', icon: <SiPlausibleanalytics className="w-8 h-8" /> },
        { name: 'Sentry', icon: <SiSentry className="w-8 h-8" /> },
      ],
    },
    {
      name: 'Tools',
      technologies: [{ name: 'Jira', icon: <FaJira className="w-8 h-8" /> }],
    },
  ];
